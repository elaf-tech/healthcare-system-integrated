                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <select id="gender" name="gender" class="form-input" required>
                                <option value="">--  {{__('web.gender')}} --</option>
                ...
                <div class="form-row">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="chronic_diseases" name="chronic_diseases" class="form-input" >
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="current_medications" name="current_medications" class="form-input" >
                        </div>
