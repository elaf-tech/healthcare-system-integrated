    ...
    <div class="app-container">
        ...
        <div class="app-header">
            ...
            <div class="header-content">
                ...
                <h1>سجل التحاليل الطبية</h1>
                <p>عرض جميع التحاليل المخبرية المسجلة</p>
            </div>
        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="cell-content">
                                        ...
                                        <span>{{ $tests->test_type }}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="cell-content">
                                        <span class="date">{{ \Carbon\Carbon::parse($tests->test_date)->format('Y-m-d') }}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="cell-content result-value {{ $tests->result_value < 50 ? 'low' : ($tests->result_value > 150 ? 'high' : 'normal') }}">
                                        <span>{{ $tests->result_value }}</span>
                                        @if($tests->unit)
                                        <span class="unit">{{ $tests->unit }}</span>
                                        @endif
                                    </div>
                                </td>
                                <td>
                                    <div class="cell-content">
                                        <span>{{ $tests->unit ?: '-' }}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="cell-content notes" title="{{ $tests->notes ?: 'لا توجد ملاحظات' }}">
                                        <span>{{ $tests->notes ?: 'لا توجد ملاحظات' }}</span>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
