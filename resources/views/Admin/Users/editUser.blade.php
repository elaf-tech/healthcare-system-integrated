        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="form-card">
                    ...
                    <!-- Admin Form -->
                    <form action="{{ route('admin.update',$user->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        @method('PUT')
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <input type="password" class="form-control" id="password_confirmation" value="{{$user->password}}" name="password_confirmation" required>
        <div class="invalid-feedback">
            يرجى تأكيد كلمة المرور
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$user->specialization}}" id="specialization" name="specialization">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" id="role" name="role" required>
                                        <option value="{{$user->role}}" selected disabled>اختر نوع المستخدم</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" id="type" name="type" required>
                                        <option value="{{$user->type}}" selected disabled>اختر نوع المستخدم</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @if ($user->image)
                                        <img src="{{ asset('storage/' . $user->image) }}" alt="{{ $user->name }}" loading="lazy" style="max-width: 100%; height: auto; border-radius: 8px;">
                                    @else
                                        <p>لا توجد صورة.</p>
                                    @endif
